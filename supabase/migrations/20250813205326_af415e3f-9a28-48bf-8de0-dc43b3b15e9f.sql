...
('minecraft', 'Minecraft', 'Build, explore and survive in infinite worlds', 'Games', '/lovable-uploads/minecraft-icon.png', 7, ARRAY['Mild Violence'], 7, 18, false, 'PC', 'Mojang Studios'),
('roblox', 'Roblox', 'Imagine, create, and share experiences with friends', 'Games', '/lovable-uploads/roblox-icon.png', 7, ARRAY['Mild Violence', 'Users Interact Online'], 7, 18, false, 'PC', 'Roblox Corporation'),
('discord', 'Discord', 'Voice, video and text communication', 'Communication', '/lovable-uploads/discord-icon.png', 13, ARRAY['Users Interact Online'], 13, 18, false, 'PC', 'Discord Inc.'),
('spotify', 'Spotify', 'Music streaming service', 'Entertainment', '/lovable-uploads/spotify-icon.png', 3, ARRAY[], 3, 18, false, 'PC', 'Spotify AB'),
('youtube', 'YouTube', 'Video sharing platform', 'Entertainment', '/lovable-uploads/youtube-icon.png', 13, ARRAY['Users Interact Online'], 13, 18, false, 'Web', 'Google'),
('chrome', 'Google Chrome', 'Web browser', 'Utilities', '/lovable-uploads/chrome-icon.png', 3, ARRAY[], 3, 18, true, 'PC', 'Google'),
('settings', 'Settings', 'System configuration', 'System', '/lovable-uploads/settings-icon.png', 3, ARRAY[], 3, 18, true, 'System', 'Guardian AI');
