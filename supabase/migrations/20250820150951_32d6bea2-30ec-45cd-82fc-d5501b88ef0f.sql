...
SELECT b.id, t.id 
FROM public.books b 
JOIN public.curriculum_topics t ON t.slug = 'science-light'
WHERE b.source_id = '5726' AND b.source = 'gutenberg'
ON CONFLICT DO NOTHING;

INSERT INTO public.book_topics (book_id, topic_id)
SELECT b.id, t.id 
FROM public.books b 
JOIN public.curriculum_topics t ON t.slug = 'science-states-of-matter'
WHERE b.source_id = '5726' AND b.source = 'gutenberg'
ON CONFLICT DO NOTHING;
...
SELECT b.id, t.id 
FROM public.books b 
JOIN public.curriculum_topics t ON t.slug = 'science-earth-space'
WHERE b.source_id = '47021' AND b.source = 'gutenberg'
ON CONFLICT DO NOTHING;

INSERT INTO public.book_topics (book_id, topic_id)
SELECT b.id, t.id 
FROM public.books b 
JOIN public.curriculum_topics t ON t.slug = 'science-electricity'
WHERE b.source_id IN ('22766','45331') AND b.source = 'gutenberg'
ON CONFLICT DO NOTHING;
...
SELECT b.id, t.id 
FROM public.books b 
JOIN public.curriculum_topics t ON t.slug = 'history-ancient-greece'
WHERE b.source_id = '23495' AND b.source = 'gutenberg'
ON CONFLICT DO NOTHING;

INSERT INTO public.book_topics (book_id, topic_id)
SELECT b.id, t.id 
FROM public.books b 
JOIN public.curriculum_topics t ON t.slug = 'history-romans-britain'
WHERE b.source_id = '66147' AND b.source = 'gutenberg'
ON CONFLICT DO NOTHING;

INSERT INTO public.book_topics (book_id, topic_id)
SELECT b.id, t.id 
FROM public.books b 
JOIN public.curriculum_topics t ON t.slug = 'history-ancient-egypt'
WHERE (b.source_id = '15663' AND b.source = 'gutenberg') OR (b.source_id = '22799' AND b.source = 'gutenberg')
ON CONFLICT DO NOTHING;

INSERT INTO public.book_topics (book_id, topic_id)
SELECT b.id, t.id 
FROM public.books b 
JOIN public.curriculum_topics t ON t.slug = 'history-stone-to-iron'
WHERE b.source_id = 'ourislandstoryhi00marsuoft' AND b.source = 'archive'
ON CONFLICT DO NOTHING;

-- 2c) Geography mappings
INSERT INTO public.book_topics (book_id, topic_id)
SELECT b.id, t.id 
FROM public.books b 
JOIN public.curriculum_topics t ON t.slug = 'geo-rivers-mountains'
WHERE b.source_id IN ('24676','30064') AND b.source = 'gutenberg'
ON CONFLICT DO NOTHING;

INSERT INTO public.book_topics (book_id, topic_id)
SELECT b.id, t.id 
FROM public.books b 
JOIN public.curriculum_topics t ON t.slug = 'geo-europe-world'
WHERE b.source_id IN ('24676','30064','22799') AND b.source = 'gutenberg'
ON CONFLICT DO NOTHING;