-- Guardian Parent Portal - Complete Schema Extension
...
INSERT INTO app_catalog (id, name, parental_category, age_rating, guardian_enabled, time_limit_recommended, detection_priority, logo_url) 
VALUES 
    ('roblox-guardian', 'Roblox', 'gaming', '9_plus', TRUE, 60, 90, 'https://logo.clearbit.com/roblox.com'),
    ('minecraft-guardian', 'Minecraft', 'gaming', 'all_ages', TRUE, 90, 85, 'https://logo.clearbit.com/minecraft.net'),
    ('youtube-guardian', 'YouTube', 'streaming', '12_plus', TRUE, 45, 95, 'https://logo.clearbit.com/youtube.com'),
    ('tiktok-guardian', 'TikTok', 'social_media', '12_plus', TRUE, 30, 80, 'https://logo.clearbit.com/tiktok.com'),
    ('netflix-guardian', 'Netflix', 'streaming', '12_plus', TRUE, 120, 70, 'https://logo.clearbit.com/netflix.com'),
    ('discord-guardian', 'Discord', 'social_media', '12_plus', TRUE, 45, 75, 'https://logo.clearbit.com/discord.com'),
    ('fortnite-guardian', 'Fortnite', 'gaming', '12_plus', TRUE, 90, 85, 'https://logo.clearbit.com/epicgames.com')
