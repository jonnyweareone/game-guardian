...
create policy "Parents can view device apps"
...
create policy "Guardian devices can insert device apps"
  on public.device_apps
  for insert
  with check (
    exists (
...
create policy "Guardian devices can update device apps"
  on public.device_apps
  for update
  using (
    exists (
...
create policy "Parents can view app policies"
...
create policy "Parents can insert app policies"
  on public.app_policies
  for insert
  with check (
    (
...
create policy "Parents can update app policies"
  on public.app_policies
  for update
  using (
    (
