...
export const CATEGORY_COLORS: Record<Category,string> = { bullying:"hsl(0 84% 60%)", grooming:"hsl(270 90% 65%)", profanity:"hsl(38 92% 60%)", hate_speech:"hsl(217 91% 60%)", self_harm:"hsl(152 76% 40%)", suspicious_contact:"hsl(340 82% 52%)" };
